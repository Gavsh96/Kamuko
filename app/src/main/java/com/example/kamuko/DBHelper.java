...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table "+ DBSchema.orderHistoryTable.NAME+"("+ DBSchema.orderHistoryTable.Cols.ID+" Text, "+ DBSchema.orderHistoryTable.Cols.ITEMS+" Text, "+ DBSchema.orderHistoryTable.Cols.DATE+" Text, "+ DBSchema.orderHistoryTable.Cols.RESTNAME+" Text, "+ DBSchema.orderHistoryTable.Cols.COST+" Text);");
